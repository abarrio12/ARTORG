...
def bc_nodes_on_plane(graph, axis, value, coords_attr="coords", eps=1e-3):
    """
    axis: 0=x, 1=y, 2=z
...
def bc_nodes_on_box_faces(graph, box, coords_attr="coords", eps=1e-3):
    """
...
def analyze_bc_for_box(graph, box, coords_attr="coords", eps=1e-3,
